...
public class SimulatorTest {
    ...
    public final static double MOE_MULTIPLIER = 1.4;
    ...
    public void land1Battle() {
        ...
        Simulator.SimulationResult r = Simulator.simulate(Battle.LAND_1, 500, 5000, maxMOE, false,
                10);
        assertTrue("Attacker survive rate " + r.attackerSurviveRate() + " close enough to " + expectedAttackerSurviveRate,
                abs(r.attackerSurviveRate() - expectedAttackerSurviveRate) < maxMOE * MOE_MULTIPLIER);
        assertTrue("Attacker survive rate " + r.defenderSurviveRate() + " close enough to " + expectedDefenderSurviveRate,
    ...
    public void sea1Battle() {
        ...
        assertTrue("Attacker survive rate " + r.attackerSurviveRate() + " close enough to " + expectedAttackerSurviveRate,
                abs(r.attackerSurviveRate() - expectedAttackerSurviveRate) < maxMOE * MOE_MULTIPLIER);
        assertTrue("Defender survive rate " + r.defenderSurviveRate() + " close enough to " + expectedDefenderSurviveRate,
                abs(r.defenderSurviveRate() - expectedDefenderSurviveRate) < maxMOE * MOE_MULTIPLIER);
        assertTrue("Attacker survive MOE " + r.attackerSurviveMOE() + " over " + maxMOE,
                r.attackerSurviveMOE() <= maxMOE);
    }
    ...
    public void sea7Battle() {
        double expectedAttackerSurviveRate = .494;
    ...
    public void seaLongBattle() {
        double expectedAttackerSurviveRate = .511;
        double expectedDefenderSurviveRate = .452;
        double maxMOE = .01;
